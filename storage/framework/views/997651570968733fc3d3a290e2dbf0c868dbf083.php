                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback <?php echo e($errors->has('mainDescriptionType') ? 'has-error' : ''); ?>">
                                            <label class="control-label">Main Description Type</label>
                                                <input style="font-weight:bold;" type="text" class="form-control"  value="<?php echo e($mainDescriptionType); ?>" name="mainDescriptionType" placeholder="Type" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">      
                                            <label class="control-label">Description Type</label>
                                                ...
                                                <input style="font-weight:bold;" type="text" class="form-control" name="desc[<?php echo e($thiskey); ?>][type]" value="<?php echo e($description->descriptionType); ?>" placeholder="Type" />
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group has-feedback">      
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">      
                                            <label class="control-label">New Description Type</label>
                                                <input style="font-weight:bold;" type="text" class="form-control" name="desc[0][type]" placeholder="New Description Type" value="general description" />
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group has-feedback">      
